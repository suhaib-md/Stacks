/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: a8c86dda06d456bc153b32c93efdf887)
// Runtime types generated with workerd@1.20260730.1 2025-09-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	DB: D1Database;
	ASSETS: Fetcher;
	SESSION_SECRET: string;
	APP_PASSPHRASE_HASH: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SESSION_SECRET" | "APP_PASSPHRASE_HASH" | "GOOGLE_BOOKS_KEY">> {}
}
